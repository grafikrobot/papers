...
note that any license grant that allows ISO to use the content in the manner
specified above is an acceptable license grant for the ISO. In particular, we
note that CC-BY is such a license grant.
