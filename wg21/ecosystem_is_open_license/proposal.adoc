...
You may ask, is that allowed? And the answer is, yes. ISO has specific wording
in the _Declaration for participants in ISO activities_
footnote:ISODeclaration[]
, in the _ISO/IEC Directives, Part 1_
...
, and in the _Clearing content added to standards_
footnote:ISOClearance[Clearing content added to standards (https://connect.iso.org/display/ipr/Clearing+content+added+to+standards)]
that makes this possible.

Lets look at those and explain how the wording allows this application below.
...
Let consider the _Declaration for participants in ISO activities_
footnote:ISODeclaration[] which we all agree to when doing anything, and even
when we log in to the iso.org web site. Bel is the full text of that
...
Which means that I, René Ferdinand Rivera Morell, post a paper to ISO/WG21 that
I have personally assigned my copyright to ISO must respect that copyright.
...
must be allowed to everything they are allowed to do if ISO held the full
...
Granting such licensing can be a laborious process requiring filling out signed
forms by all parties, and ISO does allow for that, but it can also be done in a
simpler blanket declaration as long as both sides give it. Which is what the
above is doing for the ISO side of the contract. And what copyright holders do
by appropriate use and application of the CC-BY-4.0 license.
