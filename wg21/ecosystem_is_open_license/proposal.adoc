...
Ecosystem IS aims to facilitate the interoperation of tools and systems that
...
. Individual Pnnn papers would be copyrighted by the authors and licensed under
...
. The resulting EcoIS Nnnnn draft paper and published International Standard
  would be copyrighted by the collection of authors, ISO/IEC.
. The resulting EcoIS Nnnnn draft paper and published International Standard
...
activities_ footnote:ISODeclaration[] , in the _ISO/IEC Directives, Part 1_.
...
participants in ISO activities_ is reproduced here for the reader's benefit,
with the key parts underlined:
...
The paragraph provides the context under which the rest of the paragraph is
supposed to be applied. The paragraph recognizes that parts, or even entirety,
...
original copyright holder. Such an assertion is inline with the observation
...
that gives ISO the rights to use the contents in manner specified above. We
