...
After gathering National Body comments 

NOTE: Provide for an 8 week ballot period on proposal acceptance. And 2 weeks of
comment compilation time.


* Committee stage: Development and acceptance of committee draft DIS
** 8 week ballot period
** 4 week max comment compilation
** optional?

NOTE: Per ISO/IEC Directives 2.1.6
"submission of the enquiry draft"
