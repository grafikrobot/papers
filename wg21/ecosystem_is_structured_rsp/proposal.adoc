...
* The option to add the structured response files would vary from tool to tool.
...
An example implementation to support this format externally for many tools is
planned.
