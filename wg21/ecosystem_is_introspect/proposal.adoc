...
capabilities of this standard an application supports. An application can
support either the _minimum level_ or _full level_ functionality.
...
--
`_application_ [--std-info[=_declaration_]]`
--
